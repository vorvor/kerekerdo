 ...
 */
function kerteszet_kerekerdo_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['kerekerdo_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('kerekerdo sample setting'),
  '#default_value' => theme_get_setting('kerekerdo_example'),
